...
public class LEDsConstants {
    ...
    public static final LEDPattern WINDING_UP_PATTERN = LEDPattern
        .gradient(LEDPattern.GradientType.kContinuous, Color.kRed, Color.kYellow)
        .mask(LEDPattern.progressMaskLayer(() -> Shooter.getInstance().getWheelVelocity().in(RotationsPerSecond) / Shooter.getInstance().getWheelSetpoint().in(RotationsPerSecond)));
    public static final LEDPattern WOUND_UP_PATTERN = LEDPattern
        .gradient(LEDPattern.GradientType.kContinuous, Color.kRed, Color.kYellow)
    ...
    public static final LEDPattern NORMAL_PATTERN = LEDPattern
        .solid(Color.kMediumSeaGreen)
    ...
    public static final LEDPattern AIMLOCKING_PATTERN = LEDPattern
        .gradient(LEDPattern.GradientType.kContinuous, Color.kForestGreen, Color.kRoyalBlue)
        .mask(LEDPattern.progressMaskLayer(() -> (180 - Drive.getInstance().shooterToTargetAngle) / 180));
    public static final LEDPattern AIMLOCKED_PATTERN = LEDPattern
        .gradient(LEDPattern.GradientType.kContinuous, Color.kForestGreen, Color.kRoyalBlue)
        .breathe(AIMLOCK_BREATHE_PERIOD);
