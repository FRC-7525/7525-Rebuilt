...
public enum ManagerStates implements SubsystemStates {
	...
	WINDING_UP("WINDING_UP", IntakeStates.OUT, HopperStates.IDLE, ShooterStates.SHOOT_HUB, ClimberStates.IDLE, CurrentLimiterStates.WINDING_UP),
	WINDING_UP_FIXED_SHOT("WINDING_UP_FIXED_SHOT", IntakeStates.OUT, HopperStates.IDLE, ShooterStates.SHOOT_FIXED, ClimberStates.IDLE, CurrentLimiterStates.WINDING_UP_FIXED_SHOT), //TODO: Switch back to SHOOTING_FIXED shooter state after testing is done
	...
	SHOOTING_HUB("SHOOTING_HUB", IntakeStates.OUT, HopperStates.SPINDEXING, ShooterStates.SHOOT_HUB, ClimberStates.IDLE, CurrentLimiterStates.SHOOTING_HUB),
	SHOOTING_FIXED("SHOOTING_FIXED", IntakeStates.OUT, HopperStates.SPINDEXING, ShooterStates.SHOOT_FIXED, ClimberStates.IDLE, CurrentLimiterStates.SHOOTING_FIXED),
	...
	SCORING_AUTO("AUTO SCORING", IntakeStates.INTAKE, HopperStates.SPINDEXING, ShooterStates.SHOOT_HUB, ClimberStates.IDLE, CurrentLimiterStates.SHOOTING_HUB);
